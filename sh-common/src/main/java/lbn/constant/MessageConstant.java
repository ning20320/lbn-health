...
public class MessageConstant {
    ...
    public static final String GET_CHECKITEM_LIST_SUCCESS = "查询检查项目成功";
    public static final String GET_CHECKITEM_LIST_FAIL = "查询检查项目失败";

    public static final String GET_CHECKITEM_DETAIL_SUCCESS = "查询检查项目详情成功";

    public static final String GET_CHECKITEM_DETAIL_FAIL = "查询检查项目详情失败";
}
